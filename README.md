...
Chat Navigator 是一个 Tampermonkey 用户脚本，用于在 Gemini 和 ChatGPT 对话页面中抓取、搜索、定位和导出当前对话内容，当前版本为 `2.8`。
...
- 将当前对话导出为 `.md` 文件，包含角色分段、消息序号、来源站点和时间戳；每条消息正文使用 Markdown 代码围栏包裹，方便查看和复制
...
- `2.8`：导出 Markdown 时按消息使用独立代码围栏包裹正文，支持正文内已有代码块。
